...
_LAYERPARAMETER_LAYERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_LOSS_MULTILABEL', index=30, number=30,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MULTILABEL_ACCURACY', index=31, number=31,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_LOSS_HFT', index=32, number=32,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HFT_ACCURACY', index=33, number=33,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SOFTMAX_LOSS_FCN', index=34, number=34,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_DATUM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_count', full_name='caffe.Datum.label_count', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_vector', full_name='caffe.Datum.label_vector', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_id', full_name='caffe.Datum.image_id', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hypo_id', full_name='caffe.Datum.hypo_id', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hypo_count', full_name='caffe.Datum.hypo_count', index=10,
